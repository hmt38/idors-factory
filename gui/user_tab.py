...
class UserHeaders():
    ...
    def draw(self):
        ...
        # IDOR - User Identifier Configuration
        self.userIdentifierLabel = JLabel("User Identifier (String Match):")
        self.userIdentifierString = JTextArea("Cookie: session=User" + str(self.user_id), 1, 30)
        self.userIdentifierString.setToolTipText("String to identify this user's traffic (e.g., Cookie: session=UserA)")
        self.scrollUserIdentifier = JScrollPane(self.userIdentifierString)
        self.scrollUserIdentifier.setBorder(LineBorder(Color.BLACK))
        ...
        layout.setHorizontalGroup(
            layout.createParallelGroup()
                ...
                .addComponent(self.userIdentifierLabel)
