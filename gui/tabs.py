...
from gui.idor_attack_tab import IDORAttackPanel
...
class ITabImpl(ITab):
    ...
    def getUiComponent(self):
        return self._extender.mainTabs
...
class Tabs():
    ...
    def draw(self):
        ...
        # Main Tabs integration
        self._extender.mainTabs = JTabbedPane()
        self._extender.mainTabs.addTab("Authorization", self._extender._splitpane)
        
        self._extender.idorAttackPanel = IDORAttackPanel(self._extender)
        self._extender.mainTabs.addTab("IDOR Attacks", self._extender.idorAttackPanel)
